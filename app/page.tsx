  ...
  return (
    <div className={`min-h-screen flex flex-col ${isDarkMode ? 'bg-[#1a1a1a] text-[#f0f0f0]' : 'bg-[#f0f0f0] text-[#333333]'}`}>
      ...
      <main className={`main-container shadow-sm ${isDarkMode ? 'bg-[#2c2c2c]' : 'bg-white'}`}>
        ...
        <div className={`p-[15px] rounded-[8px] my-[20px] text-left self-center w-full max-w-[300px]`}>
          <h1 className="text-2xl font-bold mb-4">GitHub Info</h1>
          <h2 className="text-[0.9em]">Latest Update: {update}</h2>
          <h2 className="text-[0.9em] my-[10px]">Stars: {stars}</h2>
          <h2 className="text-[0.9em] my-[10px]">Public Repos: {repos}</h2>
          <h2 className="mt-4 text-[0.9em]">
            <b>Visit my GitHub: </b> 
